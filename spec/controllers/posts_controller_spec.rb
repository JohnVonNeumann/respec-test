...
RSpec.describe PostsController, type: :controller do
  ...
  let(:valid_attributes) {
    { title: 'This is a valid title', content: 'This is the valid content text'}
  }
  ...
  describe "GET #elephant" do
    it 'assigns elephant instance variable' do
      comment = {'comment' => "I'm a happy elephant"}
      get :elephant, params: {}, session: valid_session
      expect(assigns(:elephant)).to eq(comment)
    end
  end
